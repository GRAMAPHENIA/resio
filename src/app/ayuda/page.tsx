    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-neutral-900 border border-neutral-800 p-6 text-center">
            <Mail className="w-8 h-8 text-info mx-auto mb-3" />
        ...
        {/* Emergencias */}
        <div className="bg-error-dark/20 border border-error p-6 mb-8">
          <div className="flex items-center gap-3 mb-3">
            <Clock className="w-6 h-6 text-error" />
            <h2 className="text-error font-semibold text-lg">¿Tienes una emergencia durante tu estadía?</h2>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-error font-semibold">+54 9 11 1234-5678</span>
            </div>
            <div className="flex items-center gap-2">
              <Mail className="w-5 h-5 text-error" />
              <span className="text-error">emergencias@resio.com</span>
            </div>
          </div>
        </div>
            ...
            return (
              <div key={categoryIndex} className="bg-neutral-900 border border-neutral-800 p-6">
                <div className="flex items-center gap-3 mb-6">
                  <CategoryIcon className="w-6 h-6 text-info" />
        ...
        <div className="bg-info-dark/20 border border-info p-6 mt-8">
          <h3 className="text-info font-semibold mb-3">¿No encontraste lo que buscabas?</h3>
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 border border-info text-info px-6 py-3 hover:bg-info-dark/30 transition-colors"
            >
